...
{
    packet::action(*event.peer, "log", "msg|>> Commands: /find /warp {world} /edit {player} /give {player} {id} {amount} /gem {give|take} {player} {amount} /punch {id} /skin {id} /sb {msg} /who /me {msg} /weather {id} /ghost /ageworld /wave /dance /love /sleep /facepalm /fp /smh /yes /no /omg /idk /shrug /furious /rolleyes /foldarms /stubborn /fold /dab /sassy /dance2 /march /grumpy /shy \0");
};
